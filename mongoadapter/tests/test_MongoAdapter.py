...
class TestMongoAdapter(unittest.TestCase):
    ...
    def test_uints(self):
        adapter = mongoadapter.MongoAdapter(TestMongoAdapter.hostname, TestMongoAdapter.port, TestMongoAdapter.db_name, 'test_uints')
    ...
    def test_ints(self):
        adapter = mongoadapter.MongoAdapter(TestMongoAdapter.hostname, TestMongoAdapter.port, TestMongoAdapter.db_name, 'test_ints')
        array = adapter[['f0', 'f1', 'f2', 'f3', 'f4']][:]
        self.assertEqual(array.size, nrecords)
    ...
    def test_floats(self):
        adapter = mongoadapter.MongoAdapter(TestMongoAdapter.hostname, TestMongoAdapter.port, TestMongoAdapter.db_name, 'test_floats')
        array = adapter[['f0', 'f1', 'f2', 'f3', 'f4']][:]
        self.assertEqual(array.size, nrecords)
    ...
    def test_behavior_of_floats_that_hold_uints(self):
        adapter = mongoadapter.MongoAdapter(TestMongoAdapter.hostname, TestMongoAdapter.port, TestMongoAdapter.db_name, 'test_behavior_of_floats_that_hold_uints')
        array = adapter[['f0', 'f1', 'f2', 'f3', 'f4']][:]
        self.assertEqual(array.size, nrecords)
        self.assertEqual(array.dtype, numpy.dtype('u8,u8,u8,u8,u8'))
        sorted = numpy.sort(array)
    ...
    def test_type_inference(self):
        adapter = mongoadapter.MongoAdapter(TestMongoAdapter.hostname, TestMongoAdapter.port, TestMongoAdapter.db_name, 'test_type_inference')
        array = adapter[['f0', 'f1', 'f2', 'f3', 'f4']][:]
        self.assertEqual(array.size, nrecords)
    ...
    def test_set_field_types(self):
        adapter = mongoadapter.MongoAdapter(TestMongoAdapter.hostname, TestMongoAdapter.port,
    ...
    def run_adapter_vs_pymongo(self, col_name, cast=False):
        adapter = mongoadapter.MongoAdapter(TestMongoAdapter.hostname, TestMongoAdapter.port, TestMongoAdapter.db_name, col_name)
        array = adapter[['f0', 'f1', 'f2', 'f3', 'f4']][:]
        try:
